...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, required=True, help="Path to YAML config (e.g. benchmarks/Robocasa_tabletop/train/alphabrain_cotrain_robocasa_gr1.yaml)")
