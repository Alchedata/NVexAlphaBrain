...
DATASET_NAMED_MIXTURES = {
    ...
    "robocasa365_pretrain300": [
        ("pretrain/*/*/*/lerobot", 1.0, "panda_omron"),
    ],
    "robocasa365_pretrain_atomic": [
        ("pretrain/atomic/*/*/lerobot", 1.0, "panda_omron"),
    ],
    "robocasa365_pretrain_composite": [
        ("pretrain/composite/*/*/lerobot", 1.0, "panda_omron"),
    ],
    "robocasa365_target50": [
        ("target/*/*/*/lerobot", 1.0, "panda_omron"),
    ],
    "robocasa365_target_atomic": [
        ("target/atomic/*/*/lerobot", 1.0, "panda_omron"),
    ],
    "robocasa365_target_composite": [
        ("target/composite/*/*/lerobot", 1.0, "panda_omron"),
    ],
    "robocasa365_target_composite_seen": [
        ("target/composite/DeliverStraw/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/GetToastedBread/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/KettleBoiling/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/LoadDishwasher/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/PackIdenticalLunches/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/PreSoakPan/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/PrepareCoffee/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/RinseSinkBasin/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/ScrubCuttingBoard/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/SearingMeat/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/SetUpCuttingStation/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/StackBowlsCabinet/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/SteamInMicrowave/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/StirVegetables/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/StoreLeftoversInBowl/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/WashLettuce/*/lerobot", 1.0, "panda_omron"),
    ],

    "robocasa365_target_composite_unseen": [
        ("target/composite/ArrangeBreadBasket/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/ArrangeTea/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/BreadSelection/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/CategorizeCondiments/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/CuttingToolSelection/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/GarnishPancake/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/GatherTableware/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/HeatKebabSandwich/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/MakeIceLemonade/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/PanTransfer/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/PortionHotDogs/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/RecycleBottlesByType/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/SeparateFreezerRack/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/WaffleReheat/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/WashFruitColander/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/WeighIngredients/*/lerobot", 1.0, "panda_omron"),
    ],

    "robocasa365_atomic_seen_5tasks": [
        ("target/atomic/NavigateKitchen/*/lerobot", 1.0, "panda_omron"),
        ("target/atomic/CloseBlenderLid/*/lerobot", 1.0, "panda_omron"),
        ("target/atomic/CoffeeSetupMug/*/lerobot", 1.0, "panda_omron"),
        ("target/atomic/OpenDrawer/*/lerobot", 1.0, "panda_omron"),
        ("target/atomic/TurnOnMicrowave/*/lerobot", 1.0, "panda_omron"),
    ],
    "robocasa365_composite_seen_5tasks": [
        ("target/composite/KettleBoiling/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/PrepareCoffee/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/LoadDishwasher/*/lerobot", 1.0, "panda_omron"),
        ("target/composite/DeliverStraw/*/lerobot", 1.0, "panda_omron"),
    ...
    "robocasa365_kettleboiling_single": [
        ("target/composite/KettleBoiling/*/lerobot", 1.0, "panda_omron"),
    ],
    ...
    "robomme": [
        ("robomme_data_lerobot", 1.0, "robomme_panda"),
    ],
